...
class WingOptimizer:
    def __init__(self, x: np.ndarray, 
                 y: np.ndarray, 
                 total_good: int, total_bad: int, 
                 n_initial: int, n_target: int,
                 bin_minimal_size: float, 
                 bin_size_increase: float, 
                 is_monotone: bool, 
        ...
        Args:
            ...
            y (np.ndarray):
                target array
            total_good (int): [description]
            total_bad (int): [description]
            n_initial (int):
                initial groups to search optimal edges
            n_target (int):
                max amout of target groups
            bin_minimal_size (float): [description]
            bin_size_increase (float): [description]
            is_monotone (bool): [description]
            optimizer (str, optional): 
                string optimizer name. Defaults to "tree-binning".
            tree_random_state ([type], optional): [description]. Defaults to None.
    ...
    def optimize(self) -> Tuple[np.ndarray, np.float]:
        ...
        Returns:
            Tuple[np.ndarray, np.float]: [description]
        """
